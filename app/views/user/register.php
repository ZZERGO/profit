...
<form  action="/register/" method="post" autocomplete="on">
    <h1>Регистрация</h1>
    <p>
        <label for="username" class="uname" data-icon="u" > Ваше имя</label><br>
        <input id="username" name="username" required="required" type="text" placeholder="например Вася Пупкин">
    </p><p>
        <label for="username" class="email" data-icon="u" > Ваш e-mail</label><br>
        <input id="username" name="email" required="required" type="text" placeholder="например vasya@pupkin.ru">
    </p>
    <p>
        <label for="password" class="password" data-icon="p"> Ваш пароль </label><br>
